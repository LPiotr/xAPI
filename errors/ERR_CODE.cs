    ...
    public class ERR_CODE(string code)
    {
        ...
        public string GetDescription()
        {
            if (stringCode.Equals(""))
                return "";
            if (stringCode.Equals(INVALID_PRICE.StringValue))
                return "Invalid price.";
            if (stringCode.Equals(INVALID_SL_TP.StringValue))
                return "Invalid SL/TP.";
            if (stringCode.Equals(INVALID_VOLUME.StringValue))
                return "Invalid volume.";
            if (stringCode.Equals(LOGIN_DISABLED.StringValue))
                return "Login disabled.";
            if (stringCode.Equals(LOGIN_NOT_FOUND.StringValue))
                return "Login not found.";
            if (stringCode.Equals(MARKET_IS_CLOSED.StringValue))
                return "Market is closed!";
            if (stringCode.Equals(MISMATCHED_PARAMETERS.StringValue))
                return "Mismatched parameters.";
            if (stringCode.Equals(MODIFICATION_DENIED.StringValue))
                return "Modification denied.";
            if (stringCode.Equals(NOT_ENOUGH_MONEY.StringValue))
                return "Not enough money!";
            if (stringCode.Equals(QUOTES_ARE_OFF.StringValue))
                return "Quotes are off!";
            if (stringCode.Equals(OPPOSITE_POSITIONS_PROHIBITED.StringValue))
                return "Opposite positions prohibited!";
            if (stringCode.Equals(SHORT_POSITIONS_PROHIBITED.StringValue))
                return "Short positions prohibited!";
            if (stringCode.Equals(PRICE_HAS_CHANGED.StringValue))
                return "Price has changed..";
            if (stringCode.Equals(REQUESTS_TOO_FREQUENT.StringValue))
                return "Requests too frequent!";
            if (stringCode.Equals(REQUOTE.StringValue))
                return "Requote..";
            if (stringCode.Equals(TOO_MANY_TRADE_REQUESTS.StringValue))
                return "Too many trade requests!";
            if (stringCode.Equals(TRADE_IS_DISABLED.StringValue))
                return "Trade is disabled.";
            if (stringCode.Equals(TRADE_TIMEOUT.StringValue))
                return "Trade timeout..";
            if (stringCode.Equals(SYMBOL_NOT_EXIST_FOR_ACCOUNT.StringValue))
                return "Symbol not existent for account.";
            if (stringCode.Equals(CANNOT_TRADE_ON_SYMBOL.StringValue))
                return "Cannot trade on symbol.";
            if (stringCode.Equals(CANNOT_CLOSE_PENDING.StringValue))
                return "Cannot close pending.";
            if (stringCode.Equals(CANNOT_CLOSE_ALREADY_CLOSED_ORDER.StringValue))
                return "Cannot close - order already closed.";
            if (stringCode.Equals(NO_SUCH_TRANSACTION.StringValue))
                return "No such transaction.";
            if (stringCode.Equals(UNKNOWN_SYMBOL.StringValue))
                return "Unknown symbol.";
            if (stringCode.Equals(UNKNOWN_TRANSACTION_TYPE.StringValue))
                return "Unknown transaction type.";
            if (stringCode.Equals(USER_NOT_LOGGED.StringValue))
                return "User not logged.";
            if (stringCode.Equals(COMMAND_NOT_EXIST.StringValue))
                return "Command does not exist.";
            if (stringCode.Equals(INTERNAL_ERROR.StringValue))
                return "Internal error.";
            return stringCode.Equals(OTHER_ERROR.StringValue) ? "Internal error (2)." : "Unknown error";
        }
    }
}
